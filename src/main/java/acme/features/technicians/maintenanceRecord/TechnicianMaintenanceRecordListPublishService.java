...
@GuiService
public class TechnicianMaintenanceRecordListPublishService extends AbstractGuiService<Technician, MaintenanceRecord> {
	...
	public void load() {
		...
		maintenanceRecords = this.repository.findMaintenanceRecordPublish();

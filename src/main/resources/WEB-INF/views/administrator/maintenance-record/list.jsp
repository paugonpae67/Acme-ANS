...
<acme:list-column code="administrator.maintenance-record.list.label.ticker" path="ticker" width="25%"/>
	<acme:list-column code="administrator.maintenance-record.list.label.maintenanceMoment" path="maintenanceMoment" width="30%"/>
	<acme:list-column code="administrator.maintenance-record.list.label.status" path="status" width="20%"/>
	<acme:list-column code="administrator.maintenance-record.list.label.nextInspection" path="nextInspection" width="30%"/>
